...
get.workdir(2025)
dir_IGME_out_folder <- file.path(get.workdir(2025), "output")
dir_IGME_out_folder_last <- file.path(get.workdir(2024), "output")
...
fig.dir <- file.path(get.workdir(2025), "fig")
...
new_dirs <- find.dir.for.VR.comparison(IGME_year_new = 2025, IGME_year_old = 2024,
...
year.lastestimatepublished = 2025
savePlotResults(runname = "UNIGME2025",
                     output.dir = output.dir,
                     legend1 = "UN IGME 2025", # if set as NULL, suppress estimates 1
                     fig.dir = fig.dir,
                     new_entry_date = "2024-12",
...
savePlotResults(runname = "GR20250530",
                     ...
                     output.dir = output.dir,
                     fig.dir = fig.dir,
                     legend1 = "UN IGME estimates 2025",
                     legend2 = "WPP 2024",
                     res.cqt2 = get.wpp.cqt("U5MR", wpp_round = 2024),
                     # legend4 = "GBD 2021",
                     # res.cqt4 = get.gbd.cqt("U5MR"),
                     legend_WPP = "WPP 2024",
                     wpp.cqt = get.wpp.cqt("U5MR", wpp_round = 2024),
